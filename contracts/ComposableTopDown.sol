    ...
    IERC721Metadata
{
    ...
    function _safeMint(address _to) public returns (uint256) {
        ...
        require(
            ...
            "ComposableTopDown: transfer to non ERC721Receiver implementer"
        );
    ...
    function getERC20(
        ...
        if (!allowed) {
            ...
            (bool callSuccess, bytes memory data) = _erc20Contract.staticcall(
                callData
            );
            require(
                callSuccess,
    ...
    function erc20Received(
        ...
        _updateStateHash(
            _tokenId,
            uint256(uint160(_erc20Contract)),
            erc20Balance + _value
        );
    ...
    function stateHash(uint256 tokenId) public view returns (uint256) {
        ...
        require(
            _stateHash > 0,
            "ComposableTopDown: stateHash of _tokenId is zero"
        );
        return _stateHash;
    }
    ...
    function safeCheckedTransferFrom(
        ...
        require(
            ...
            "ComposableTopDown: stateHash mismatch (1)"
        );
    ...
    function checkedTransferFrom(
        ...
        require(
            expectedStateHash == tokenIdToStateHash[tokenId],
            "ComposableTopDown: stateHash mismatch (2)"
        );
    ...
    function safeCheckedTransferFrom(
        ...
        require(
            expectedStateHash == tokenIdToStateHash[tokenId],
            "ComposableTopDown: stateHash mismatch (3)"
        );
